...
const CustomControls = () => {
  ...
  return (
    <div className="absolute z-50 pointer-events-auto  left-4 bottom-4 flex flex-col gap-1 p-2 bg-stone-800 shadow-lg [&>*]:bg-yellow-700 rounded-md border-2 border-stone-700">
